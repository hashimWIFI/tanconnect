...
<head>
    ...
    <style>
       ...
       .btn-portal { background: #3498db; color: white;  border: 2px solid grey; padding: 14px; font-size: 14px; border-radius: 6px; cursor: pointer; text-decoration: none; display: inline-block; margin-top: 2px; width: 100%; box-sizing: border-box; font-weight: bold; }
     .btn-portal:active { transform: scale(0.98); }
        .btn-portal:hover { filter: brightness(0.95); }
