...
<p style="font-size: 14px; color: black; line-height: 1.5; margin-top: 15px;">Mtambo umeshindwa kuchakata vifurushi vya <strong>Tsh<?php echo htmlspecialchars($amount); ?> </strong>. Tafadhali jaribu vifurushi vingine.</p>
