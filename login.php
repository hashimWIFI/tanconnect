...
<p style="font-size: 14px; color: black; line-height: 1.5; margin-top: 15px;">Mtambo umeshindwa kuchakata vifurushi vya Tsh. <?php echo htmlspecialchars($amount); ?>. Tafadhali rudi nyuma kuchagua kifurushi kingine.</p>
