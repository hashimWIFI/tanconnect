...
$resetQuery = "UPDATE wifi_vouchers SET status = 'AVAILABLE', purchased_at = NULL WHERE status = 'PENDING'";
...
if ($conn->query($resetQuery) === TRUE) {
    ...
    echo "✓ Status columns flipped cleanly from 'PENDING' back to 'AVAILABLE'.\n";
