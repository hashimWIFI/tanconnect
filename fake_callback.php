...
if ($conn->query($updateQuery) === TRUE) {
    ...
    if ($customer_phone) {
        ...
        // REWRITTEN SECTION: Using file_get_contents stream context to completely bypass broken local cURL network wrappers
        $api_url = "https://textbee.dev" . $textbee_device_id . "/send-sms";
        ...
        $textbee_response = @file_get_contents($api_url, false, $context);
        
        // Parse out the HTTP system response code header
        $http_code = 0;
