...
.btn-submit { background:#0056b3; color:#0056b3;  border: 1px solid #334155; width: 30%; padding: 14px; font-color: white; font-size: 14px; font-weight: bold; border-radius: 6px; cursor: pointer; transition: all 0.3s ease; }
