...
<button type="button" id="submit-payment-btn" class="btn-popup-pay" style="margin: 0; padding: 0 30px; background: #3498db; border-radius: 6px; font-size: 13px; color: #ffffff; font-weight: bold; min-width: 100px;" onclick="dispatchToRailway(event)">Pay</button>                </div></div>
