...
<body>
    ...
    <div class="container">
        ...
        <div class="portal-card">
            ...
            <div class="subtitle">
                <marquee behavior="scroll" direction="left" scrollamount="4" style="color: black; border-bottom: 1px solid #334155; font-weight: bold; font-size: 13px; margin-bottom: 6px;font-family: 'Segoe UI', Arial, sans-serif;">
