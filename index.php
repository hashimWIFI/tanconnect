...
<div class="subtitle">
<marquee behavior="scroll" direction="left" scrollamount="4" style="color: black; border-bottom: 2px solid #e2e8f0; font-weight: bold; font-size: 13px; margin-bottom: 10px;font-family: 'Segoe UI', Arial, sans-serif;"> Ndugu mteja, karibu kwenye mtandao wa Wi-Fi wa TANConnect || Tunakuletea internet isiyo na ukomo wa kasi kuperuzi mtandaoni || Fuata maelekezo hapa chini kununua Voucher kupitia simu yako ya mkononi || Kwa ufafanuzi, malamiko au maelekezo zaidi, wasiliana nasi kwa nambari 0713 123 974 <br></marquee> <br></div>

<div style="font-weight: bold; font-size: 13px; color: black; text-align: left;">Bonyeza kifurushi unachohitaji kununua:<br><br>

<div class="package-grid">
<div class="package-card" onclick="selectPackage('500', '500 TZS || Masaa 6 kuperuzi || Unlimited DATA')">
<div class="card-price">500<span style= "font-size: 8px; font-weight: bold; color: #34495e;"> TZS</span></div>
<div class="card-time">Saa 6</div>
<div class="card-data">Unlimited DATA</div></div>
...
<div class="card-price1">20,000<span style= "font-size: font-weight: bold; color: #34495e;"> TZS</span></div>
...
<form id="payment-form" action="login.php" method="post" onsubmit="return captureRouterData(event)">
      ...
      <input class="btn-submit" name="customer_phone" id="phone-number" pattern="[0]{1}[6-7]{1}[0-9]{8}" type="tel" placeholder="0713123974" 
...
<div class="loading-text">TUNAWASILIANA NA MTANDAO WAKO <br> TAFADHALI SUBIRI ...</div></div>
<footer style="margin-top: 10px; padding: 10px 10px; text-align: center; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; border-radius: 8px; font-size: 8px; color: #555555; background-color: #fafafa;">

<p style="margin: 0 0 10px 0; font-weight: bold;"> © 2026 NIT Africa Solutions Limited. All Rights Reserved. 
<br>TANConnect<sup style="font-family: Arial, Helvetica, sans-serif; font-size: 6px; font-weight: normal; vertical-align: super; line-height: 0;">&reg;</sup> is a registered trademark of<a href= https://nitafricasolutions-production-2f54.up.railway.app style="color: #0066cc; text-decoration: none; font-weight: bold;"> NIT Africa Solutions Limited</a></p>
