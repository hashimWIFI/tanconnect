...
<head>
    ...
    <style>
        ...
        .btn-home { background: #3498db; color: white; border: none; padding: 14px; font-size: 14px; border-radius: 6px; cursor: pointer; text-decoration: none; display: inline-block; margin-top: 5px; width: 100%; box-sizing: border-box; font-weight: bold; }
    </style>
</head>
<body>
