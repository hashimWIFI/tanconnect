...
<head>
    ...
    <title>TANConnect - Terms & Conditions</title>
      <style>
...
By executing a commercial purchase request on <b>TANConnect<sup style="font-family: Arial, Helvetica, sans-serif; font-size: 8px; font-weight: normal; vertical-align: super; line-height: 0;">&reg;</sup> </b>, you are buying a digital access authorization voucher for our wireless connectivity network footprint. Access is valid strictly for the continuous time interval purchased. Users are prohibited from utilizing this connectivity connection to run illegal distributed networking software, distribute bulk electronic text mail blocks, or participate in malicious cyber actions.</p>
